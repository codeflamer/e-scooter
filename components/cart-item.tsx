      ...
      <div className="grid grid-cols-12 text-base-black px-[21px] py-[11px] rounded-md space-x-2">
        <div className="col-span-6">
          <div className="flex space-x-[19px] items-center">
            ...
            />
            <div>
              <h3 className="text-[17px] md:text-[20px] font-semibold">
                Kugoo Kirin M4
              </h3>
              <p className="flex flex-col md:flex-row items-center justify-between md:space-x-2">
                <div className="flex items-center">
                  ...
                  <span className="text-[#5D6C7B] text-[12px]">В наличии</span>{" "}
                </div>
        ...
        <h5 className="col-span-2 flex flex-col justify-center items-center">
          <div className="w-[80px] md:w-[120px] flex items-center justify-between px-[17px] py-[8px] rounded-md bg-[#F4F7FB]">
            <div className="text-[#5D6C7B] text-[14px] md:text-[17px] cursor-pointer">
              -
            </div>
            <div className="text-[14px] md:text-[16px]">1</div>
            <div className="text-[#5D6C7B] text-[14px] md:text-[17px] cursor-pointer">
              +
            </div>
          </div>
        </h5>
        <h5 className="col-span-2 font-semibold text-base-black text-[15px] md:text-[20px] text-center flex flex-col items-center justify-center">
          29 900 ₽
        </h5>
