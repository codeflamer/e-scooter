...
const CTA = () => {
  return (
    <div className="p-5 md:flex md:flex-row items-center justify-between max-w-screen-2xl mx-auto md:space-x-10 flex-col">
      <p className="text-bold uppercase text-[18px] max-w-[600px]">
        Оставьте свою почту и станьте первым, кто получит скидку на новые
        самокаты
      </p>

      <form className="flex md:space-x-3 flex-1 md:justify-end mt-4 md:mt-0">
...
bg-white/30 w-full min-w-[300px] max-w-[600px] mr-3"
          required
        ...
        <Button
          htmlType="submit"
          className="!bg-white !border-none !text-base !py-7 !font-semibold !px-4"
        >
          Подписаться
        </Button>
      </form>
